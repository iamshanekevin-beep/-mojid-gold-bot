    ...
    try:
        async with httpx.AsyncClient(timeout=5) as client:
            ...
            if res.status_code == 200:
                ...
                return {"spot": round(spot, 2), "iq_price": round(spot * 1.4197, 1), "source": "Binance", "status": "ok"}
    except Exception:
        pass
    ...
    try:
        async with httpx.AsyncClient(timeout=5) as client:
            ...
            if res.status_code == 200:
                ...
                return {"spot": round(spot, 2), "iq_price": round(spot * 1.4197, 1), "source": "CoinGecko", "status": "ok"}
    except Exception:
        pass
